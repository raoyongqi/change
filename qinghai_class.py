...
tif_file = r"C:\Users\r\Desktop\export\qinghai\extracted\extracted_qinghai_idgp_2001.tif"
...
import glob
# 定义栅格文件夹路径
raster_folder = r"C:\Users\r\Desktop\export\qinghai\extracted"
...
for raster_path in raster_files:
    ...
    with arcpy.da.SearchCursor(raster_path, [sym_lab_field, "Count"]) as cursor:
        ...
        for class_name in top_4_values[1:(len(top_4_values)-1)]:
            output_folder = f"C:\\Users\\r\\Desktop\\export\\qinghai\\{class_name}"
            ...
            # 输出栅格文件的路径
            output_raster = os.path.join(output_folder, f"qinghai_{class_name}_{year}.tif")
