...
# 设置要扫描的目录路径
parent_folder = r"C:\Users\r\Desktop\export\gansu"
        ...
        for file in os.listdir(folder_path):  # 使用 os.listdir 只列出当前目录下的文件
            ...
            if os.path.isfile(file_path) and file.lower().endswith(".tif"):
                ...
                if '2001' in file:
                    ...
                    match = re.match(r"([a-zA-Z_]+)_\d{4}\.tif", file)  # 匹配类似 gansu_Grasslands_YYYY.tif
                ...
                if tif_2001 is not None and tif_2020 is not None:
                    ...
                    output_folder = os.path.join(parent_folder, "gansu_diff")  # 创建 result 文件夹路径
                    # 获取栅格的属性表
                    ...
                    # 拼接输出文件的完整路径
                    output_raster = os.path.join(output_folder, f"gansu_{basename}_diff.tif")
