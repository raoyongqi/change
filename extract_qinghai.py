...
# 输入栅格数据和掩膜文件
input_raster_folder = r"C:\Users\r\Desktop\export\qinghai\qinghai"  # 输入栅格数据路径
mask_shapefile = r"C:\Users\r\Desktop\export\province\qinghai\qinghai.shp"  # 掩膜矢量文件路径

# 输出文件夹路径
output_raster_folder = r"C:\Users\r\Desktop\export\qinghai\extracted"  # 输出文件夹路径
